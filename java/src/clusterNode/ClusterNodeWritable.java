...
public class ClusterNodeWritable extends Writable<ClusterNodeFile> {
    ...
    public void set(Node url) {
        ...
        this.content = "";
        this.nnid = url.getNearestNeighborIds();
        this.nnscore = url.getNearestNeighborScores();
    }
    ...
    public ArrayList<Long> getNearestNeighborIds() {
    ...
    public ArrayList<Double> getNearestNeighborScores() {
